! function(e) {
    ...
    function N(e, r, n) {
        ...
        var O, y, b, E, A, S, R, _, B, D, P = $.prototype = {
                constructor: $,
                toString: null,
                valueOf: null
            },
        ...
        function $(e, r) {
            ...
            if (!(w instanceof $)) return new $(e, r);
            if (null == r) {
                ...
                if (d(r, 2, j.length, "Base"), 10 == r) return W(w = new $(e), L + w.e + 1, U);
                if (p = String(e), h = "number" == typeof e) {
                    if (0 * e != 0) return b(w, p, h, r);
                    if (w.s = 1 / e < 0 ? (p = p.slice(1), -1) : 1, $.DEBUG && p.replace(/^0\.0*|\./, "").length > 15) throw Error(s + e)
            ...
            if (p = p.slice(a, ++g)) {
                if (g -= a, h && $.DEBUG && g > 15 && (e > l || e !== i(e))) throw Error(s + w.s * e);
        ...
        function z(e, r, n, t) {
            ...
            else if (o = (e = W(new $(e), r, n)).e, f = (u = p(e.c)).length, 1 == t || 2 == t && (r <= o || o <= I)) {
                for (; f < r; u += "0", f++);
                u = v(u, o)
        ...
        return $.clone = e, $.ROUND_UP = 0, $.ROUND_DOWN = 1, $.ROUND_CEIL = 2, $.ROUND_FLOOR = 3, $.ROUND_HALF_UP = 4, $.ROUND_HALF_DOWN = 5, $.ROUND_HALF_EVEN = 6, $.ROUND_HALF_CEIL = 7, $.ROUND_HALF_FLOOR = 8, $.EUCLID = 9, $.config = $.set = function(e) {
            ...
            return function(n, t, i, o, s) {
                var f, u, l, c, a, h, g, w, d = n.indexOf("."),
                    m = L,
                    v = U;
                for (d >= 0 && (c = F, F = 0, n = n.replace(".", ""), h = (w = new $(t)).pow(n.length - d), F = c, w.c = r(N(p(h.c), h.e, "0"), 10, i, e), w.e = w.c.length), l = c = (g = r(n, t, i, s ? (f = j, e) : (f = e, j))).length; 0 == g[--c]; g.pop());
                if (!g[0]) return f.charAt(0);
                if (d < 0 ? --l : (h.c = g, h.e = l, h.s = o, g = (h = O(h, w, m, v, i)).c, a = h.r, l = h.e), d = g[u = l + m + 1], c = i / 2, a = a || u < 0 || null != g[u + 1], a = v < 4 ? (null != d || a) && (0 == v || v == (h.s < 0 ? 3 : 2)) : d > c || d == c && (4 == v || a || 6 == v && 1 & g[u - 1] || v == (h.s < 0 ? 8 : 7)), u < 1 || !g[0]) n = a ? N(f.charAt(1), -m, f.charAt(0)) : f.charAt(0);
                else {
                    if (g.length = u, a)
            ...
            return function(t, o, s, l, c) {
                var a, h, p, w, d, m, v, N, O, y, b, E, A, S, R, _, B, D = t.s == o.s ? 1 : -1,
                    P = t.c,
                    x = o.c;
                if (!(P && P[0] && x && x[0])) return new $(t.s && o.s && (P ? !x || P[0] != x[0] : x) ? P && 0 == P[0] || !x ? 0 * D : D / 0 : NaN);
                for (O = (N = new $(D)).c = [], D = s + (h = t.e - o.e) + 1, c || (c = f, h = g(t.e / u) - g(o.e / u), D = D / u | 0), p = 0; x[p] == (P[p] || 0); p++);
                    ...
                    do {
                        if (d = 0, (a = r(x, y, _, b)) < 0) {
                            if (E = y[0], _ != b && (E = E * c + (y[1] || 0)), (d = i(E / R)) > 1)
                                for (d >= c && (d = c - 1), v = (m = e(x, d, c)).length, b = y.length; 1 == r(m, y, v, b);) d--, n(m, _ < v ? B : x, v, c), v = m.length, a = 1;
                ...
                if (c == f) {
                    ...
                    W(N, s + (N.e = p + h * u - 1) + 1, l, w)
                } else N.e = h, N.r = +w;
                return N
            }
        }(), S = /^(-?)0([xbo])(?=\w[\w.]*$)/i, R = /^([^.]+)\.$/, _ = /^\.([^.]+)$/, B = /^-?(Infinity|NaN)$/, D = /^\s*\+(?=[\w.])|^\s+|\s+$/g, b = function(e, r, n, t) {
            ...
            if (B.test(s)) e.s = isNaN(s) ? null : s < 0 ? -1 : 1;
                ...
                if (!n && (s = s.replace(S, (function(e, r, n) {
                    ...
                    })), t && (i = t, s = s.replace(R, "$1").replace(_, "0.$1")), r != s)) return new $(s, i);
                if ($.DEBUG) throw Error(o + "Not a" + (t ? " base " + t : "") + " number: " + r);
                e.s = null
            }
            e.c = e.e = null
            ...
            var n, t, i, o = this;
            if (null != e) return d(e, 0, h), null == r ? r = U : d(r, 0, 8), W(new $(o), e + o.e + 1, r);
            if (!(n = o.c)) return null;
            if (t = ((i = n.length - 1) - g(this.e / u)) * u, i = n[i])
                for (; i % 10 == 0; i /= 10, t--);
            return t < 0 && (t = 0), t
        }, P.dividedBy = P.div = function(e, r) {
            return O(this, new $(e, r), L, U)
        }, P.dividedToIntegerBy = P.idiv = function(e, r) {
            return O(this, new $(e, r), 0, 1)
        }, P.exponentiatedBy = P.pow = function(e, r) {
            var n, s, f, l, c, a, h, g, p = this;
            if ((e = new $(e)).c && !e.isInteger()) throw Error(o + "Exponent not an integer: " + X(e));
            if (null != r && (r = new $(r)), c = e.e > 14, !p.c || !p.c[0] || 1 == p.c[0] && !p.e && 1 == p.c.length || !e.c || !e.c[0]) return g = new $(Math.pow(+X(p), c ? 2 - m(e) : +X(e))), r ? g.mod(r) : g;
            if (a = e.s < 0, r) {
                if (r.c ? !r.c[0] : !r.s) return new $(NaN);
                (s = !a && p.isInteger() && r.isInteger()) && (p = p.mod(r))
            } else {
                if (e.e > 9 && (p.e > 0 || p.e < -1 || (0 == p.e ? p.c[0] > 1 || c && p.c[1] >= 24e7 : p.c[0] < 8e13 || c && p.c[0] <= 9999975e7))) return l = p.s < 0 && m(e) ? -0 : 0, p.e > -1 && (l = 1 / l), new $(a ? 1 / l : l);
                F && (l = t(F / u + 2))
            }
            for (c ? (n = new $(.5), a && (e.s = 1), h = m(e)) : h = (f = Math.abs(+X(e))) % 2, g = new $(x);;) {
                if (h) {
                ...
                if (f) {
                    if (0 === (f = i(f / 2))) break;
                    h = f % 2
                } else if (W(e = e.times(n), e.e + 1, 1), e.e > 14) h = m(e);
                else {
                    if (0 === (f = +X(e))) break;
                    h = f % 2
                }
            ...
            return s ? g : (a && (g = x.div(g)), r ? g.mod(r) : l ? W(g, F, U, undefined) : g)
        }, P.integerValue = function(e) {
            var r = new $(this);
            return null == e ? e = U : d(e, 0, 8), W(r, r.e + 1, e)
            ...
            var n, t, i, o, s = this,
                l = s.s;
            if (r = (e = new $(e, r)).s, !l || !r) return new $(NaN);
            ...
            if (!c || !a) {
                ...
                if (!h[0] || !p[0]) return p[0] ? (e.s = -r, e) : new $(h[0] ? s : 3 == U ? -0 : 0)
            }
            ...
            return h[0] ? V(e, h, a) : (e.s = 3 == U ? -1 : 1, e.c = [e.e = 0], e)
        }, P.modulo = P.mod = function(e, r) {
            var n, t, i = this;
            return e = new $(e, r), !i.c || !e.s || e.c && !e.c[0] ? new $(NaN) : !e.c || i.c && !i.c[0] ? new $(i) : (9 == k ? (t = e.s, e.s = 1, n = O(i, e, 0, 3), e.s = t, n.s *= t) : n = O(i, e, 0, k), (e = i.minus(n.times(e))).c[0] || 1 != k || (e.s = i.s), e)
            ...
            var o = t.e / u,
                ...
                c = e.c;
            if (!o || !s) {
                if (!l || !c) return new $(i / 0);
                if (!l[0] || !c[0]) return c[0] ? e : new $(l[0] ? t : 0 * i)
            }
            ...
            return i && (l = [i].concat(l), ++s), V(e, l, s)
        }, P.precision = P.sd = function(e, r) {
            var n, t, i, o = this;
            if (null != e && e !== !!e) return d(e, 1, h), null == r ? r = U : d(r, 0, 8), W(new $(o), e, r);
            if (!(n = o.c)) return null;
            ...
            var e, r, n, t, i, o = this,
                ...
                l = L + 4,
                c = new $("0.5");
            if (1 !== f || !s || !s[0]) return new $(!f || f < 0 && (!s || s[0]) ? NaN : s ? o : 1 / 0);
            if (0 == (f = Math.sqrt(+X(o))) || f == 1 / 0 ? (((r = p(s)).length + u) % 2 == 0 && (r += "0"), f = Math.sqrt(+r), u = g((u + 1) / 2) - (u < 0 || u % 2), n = new $(r = f == 1 / 0 ? "5e" + u : (r = f.toExponential()).slice(0, r.indexOf("e") + 1) + u)) : n = new $(f + ""), n.c[0])
                for ((f = (u = n.e) + l) < 3 && (f = 0);;)
                    if (i = n, n = c.times(i.plus(O(o, i, l, 1))), p(i.c).slice(0, f) === (r = p(n.c)).slice(0, f)) {
                        if (n.e < u && --f, "9999" != (r = r.slice(f - 3, f + 1)) && (t || "4999" != r)) {
                            +r && (+r.slice(1) || "5" != r.charAt(0)) || (W(n, n.e + L + 2, 1), e = !n.times(n).eq(o));
                            break
                        }
                        if (!t && (W(i, i.e + L + 2, 0), i.times(i).eq(o))) {
                            n = i;
                            break
                        }
                        l += 4, f += 4, t = 1
                    }
            return W(n, n.e + L + 1, U, e)
        }, P.toExponential = function(e, r) {
            return null != e && (d(e, 0, h), e++), z(this, e, r, 1)
        }, P.toFixed = function(e, r) {
            return null != e && (d(e, 0, h), e = e + this.e + 1), z(this, e, r)
        }, P.toFormat = function(e, r, n) {
            var t, i = this;
            if (null == n) null != e && r && "object" == typeof r ? (n = r, r = null) : e && "object" == typeof e ? (n = e, e = r = null) : n = q;
            ...
            var r, n, t, i, s, f, l, a, h, g, w, d, m = this,
                v = m.c;
            if (null != e && (!(l = new $(e)).isInteger() && (l.c || 1 !== l.s) || l.lt(x))) throw Error(o + "Argument " + (l.isInteger() ? "out of range: " : "not an integer: ") + X(l));
            if (!v) return new $(m);
            for (r = new $(x), h = n = new $(x), t = a = new $(x), d = p(v), s = r.e = d.length - m.e - 1, r.c[0] = c[(f = s % u) < 0 ? u + f : f], e = !e || l.comparedTo(r) > 0 ? s > 0 ? r : h : l, f = M, M = 1 / 0, l = new $(d), a.c[0] = 0; g = O(l, r, 0, 1), 1 != (i = n.plus(g.times(t))).comparedTo(e);) n = t, t = i, h = a.plus(g.times(i = h)), a = i, r = l.minus(g.times(i = r)), l = i;
            ...
            return null != e && d(e, 1, h), z(this, e, r, 2)
        }, P.toString = function(e) {
            var r, n = this,
                t = n.s,
                i = n.e;
            return null === i ? t ? (r = "Infinity", t < 0 && (r = "-" + r)) : r = "NaN" : (null == e ? r = i <= I || i >= T ? v(p(n.c), i) : N(p(n.c), i, "0") : 10 === e ? r = N(p((n = W(new $(n), L + i + 1, U)).c), n.e, "0") : (d(e, 2, j.length, "Base"), r = y(N(p(n.c), i, "0"), 10, e, t, !0)), t < 0 && n.c[0] && (r = "-" + r)), r
